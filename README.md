...
├── .gitignore
├── README.md
├── label_taxonomy.json        # Configuration for the cleanup proposal script
...
│       │   ├── __init__.py
│       │   ├── fetch.py       # CLI command for fetching data
│       │   ├── generate.py    # CLI command for generating metrics
│       │   ├── score.py       # CLI command for calculating score
│       │   ├── report.py      # CLI command for generating final report
│       │   └── summary.py     # CLI command for generating lean summary
│       ├── config/            # Configuration management
│       │   ├── __init__.py
│       │   └── settings.py    # Settings and environment variables
│       ├── data/              # Data processing modules
│       │   ├── __init__.py
│       │   └── fetcher.py     # GraphQL data fetcher and normalizer
│       ├── engine/            # Metrics calculation and reporting
│       │   ├── __init__.py
│       │   ├── metrics.py     # Metrics calculation logic
│       │   ├── reporter.py    # Report generation
│       │   ├── scorer.py      # Deterministic scoring logic
│       │   └── final_reporter.py # Comprehensive report generation
